...
#It's a compatibility issue with the new Matrix package version (1.6-2). 
#Just install the previous version (1.6-1) and you should be fine
...
for (i in 1:length(separate.files)){
 ...
 df <- df %>%
   mutate(cluster_name = case_when(
     ...
     cluster == 17 ~ 'Immune/cancer cells', #CD3+CK+
